...
<template>
    ...
    <div class="flex items-center justify-between gap-6">
        <div class="flex items-center gap-4">
            <!-- Code -->
            <span class="font-mono text-sm font-semibold text-gray-500 bg-gray-50 px-3 py-2 rounded-lg">
                {{ bureau.code }}
            </span>
            ...
            <div>
                ...
                <div class="mt-1">
                    <span
                        v-if="bureau.is_procuration"
                        class="inline-flex items-center gap-1.5 rounded-full bg-purple-100 px-2.5 py-1 text-xs font-semibold text-purple-700"
                    >
                        <svg
                        ...
                        >
                            <path
                                ...
                                stroke-width="2"
                                d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-5.13a4 4 0 11-6 0 4 4 0 016 0zm6 3a4 4 0 10-3.5-6.5"
                            />
                        </svg>
                        Procuration
                    </span>
        ...
        <!-- Statut -->
        <span
            :class="statusLabel[bureau.status]?.cls ?? 'bg-gray-100 text-gray-600'"
            class="text-sm font-medium px-3 py-1.5 rounded-full shrink-0"
        >
