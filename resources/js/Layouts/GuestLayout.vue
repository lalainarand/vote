<script setup>
// Layout minimaliste pour les pages non authentifiées (login)
</script>

<template>
    <div class="min-h-screen bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
